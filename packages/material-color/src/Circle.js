...
const ColorCircle = ({circleSpacing = 12, circleSize = 28, ...props}) => {
...
const ColorCircleStatic = ({circleSpacing = 12, circleSize = 28, ...props}) => {
    const {palette,} = useTheme();
...
export {ColorCircle, ColorCircleStatic}

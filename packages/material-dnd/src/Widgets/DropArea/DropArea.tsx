...
import { memo, Trans, TransTitle, UIStoreActionListItemAdd, WidgetProps, WithOnChange } from '@ui-schema/ui-schema'
...
export const DropAreaBase = (
    {
        widgets,
        ...props
    }: WidgetProps<{}, DragDropBlockComponentsBinding> & WithOnChange
): React.ReactElement => {

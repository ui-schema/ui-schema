...
export const IcSubscript: React.ComponentType<{}> = () => <svg enableBackground="new 0 0 24 24" viewBox="0 0 24 24" fill={'currentColor'} color={'inherit'} width="18px" height="18px">
    <g>

...
/**
 * npm run tdd -- --testPathPattern=src/storeBuildScopeTree2/storeBuildScopeTree.test.ts --selectProjects=test-@ui-schema/react
 */
    ...
    test.each([
        ...
        if (isExpected !== args.expectedSameness) {
            console.log(
                ...
                // JSON.stringify(args.store, undefined, 4),

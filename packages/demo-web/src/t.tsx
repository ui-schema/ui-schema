...
import { makeTranslator, translation, TranslatorDictionary } from '@ui-schema/ui-schema/Translator'
...
const BtsMinus = () => {
    return <svg className={['bi', 'bi-dash-circle'].join(' ')} width={20} height={20} viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

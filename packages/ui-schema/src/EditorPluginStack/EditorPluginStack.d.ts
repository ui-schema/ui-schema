...
export function NextPluginRenderer<P extends EditorPluginProps>(props: P): React.ReactElement<P>

export function NextPluginRendererMemo<P extends EditorPluginProps>(props: P): React.ReactElement<P>
